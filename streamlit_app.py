...
def get_recommendations(engine, user_id, n_recommendations, method):
    ...
    try:
        ...
        if method == "hybrid":
            return engine.get_hybrid_recommendations(user_id, n_recommendations)
        elif method == "similarity":
            return engine.collaborative_filtering.get_recommendations(user_id, n_recommendations, method='item_based')
        elif method == "ml":
            return engine.get_ml_recommendations(user_id, n_recommendations)
        else:
            return generate_synthetic_recommendations(user_id, n_recommendations)
